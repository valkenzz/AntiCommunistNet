...
parser.add_argument('--folder_path', default='/media/seagate/vmeo/campagne/petit', type=str,
                    help='The folder path')
parser.add_argument('--train_filename', default='./data_flist/train_shuffled.flist.txt', type=str,
                    help='The output filename.')
parser.add_argument('--validation_filename', default='./data_flist/validation_shuffled.flist.txt', type=str,
                    help='The output filename.')
