...
def evaluate(model, data_path, mode='valid'):
    ...
    dataset_real = FFDataset(dataset_root=real_root, size=299, frame_num=1000, augment=False)
    dataset_fake, _ = get_dataset(name=mode, root=origin_root, size=299, frame_num=1000, augment=False)
